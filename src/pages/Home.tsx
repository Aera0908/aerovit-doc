      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-[var(--text-secondary)] mb-4 max-w-3xl mx-auto">
            AI-Powered Fitness Platform with Gamified Training System
          </p>
          <p className="text-[var(--text-muted)] mb-10 max-w-2xl mx-auto">
            ...
            and intelligent coaching inspired by Solo Leveling's progression system.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <FeatureCard
              ...
              description="Solo Leveling-inspired daily challenges that adapt to your fitness level. Complete quests to earn XP and level up your hunter rank."
            />
            <FeatureCard
              icon={<AIIcon />}
