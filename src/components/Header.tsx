    ...
    <header className="hud-panel sticky top-0 z-50 border-b border-[var(--primary)]/20 bg-[var(--surface)]/95 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          {/* Desktop GitHub Link - Currently Unavailable */}
          <span
            className="hidden md:flex items-center space-x-2 text-sm text-[var(--text-muted)] opacity-50 cursor-not-allowed"
        ...
        {mobileMenuOpen && (
          <nav className="md:hidden mt-4 py-2 border-t border-[var(--primary)]/10">
            ...
            <span
              className="flex items-center space-x-2 py-2 px-4 text-sm text-[var(--text-muted)] opacity-50 cursor-not-allowed"
              title="Currently Unavailable"
            >
